...
, { noremap = true, silent = true, desc = "Search History" })

-- @key-map press ;r find file that contains the regex
vim.keymap.set('n', ';r',
  "<cmd>lua require('telescope.builtin').live_grep({ path = '%:p:h' })<CR>",
...
vim.keymap.set('n', ';;', "<cmd>lua require('telescope.builtin').resume()<CR>",
  { noremap = true, silent = true, desc = "Resume to previous file" })
